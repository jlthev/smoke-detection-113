...
create3_examples_msgs__action__Coverage_Goal__create()
{
  ...
  create3_examples_msgs__action__Coverage_Goal * msg = (create3_examples_msgs__action__Coverage_Goal *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
create3_examples_msgs__action__Coverage_Goal__Sequence__init(create3_examples_msgs__action__Coverage_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (create3_examples_msgs__action__Coverage_Goal *)allocator.zero_allocate(size, sizeof(create3_examples_msgs__action__Coverage_Goal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_Goal__Sequence * array = (create3_examples_msgs__action__Coverage_Goal__Sequence *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  create3_examples_msgs__action__Coverage_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    create3_examples_msgs__action__Coverage_Goal * data =
      (create3_examples_msgs__action__Coverage_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!create3_examples_msgs__action__Coverage_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          create3_examples_msgs__action__Coverage_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_Result * msg = (create3_examples_msgs__action__Coverage_Result *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
...
create3_examples_msgs__action__Coverage_Result__Sequence__init(create3_examples_msgs__action__Coverage_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (create3_examples_msgs__action__Coverage_Result *)allocator.zero_allocate(size, sizeof(create3_examples_msgs__action__Coverage_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_Result__Sequence * array = (create3_examples_msgs__action__Coverage_Result__Sequence *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  create3_examples_msgs__action__Coverage_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    create3_examples_msgs__action__Coverage_Result * data =
      (create3_examples_msgs__action__Coverage_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!create3_examples_msgs__action__Coverage_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          create3_examples_msgs__action__Coverage_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_Feedback * msg = (create3_examples_msgs__action__Coverage_Feedback *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
...
create3_examples_msgs__action__Coverage_Feedback__Sequence__init(create3_examples_msgs__action__Coverage_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (create3_examples_msgs__action__Coverage_Feedback *)allocator.zero_allocate(size, sizeof(create3_examples_msgs__action__Coverage_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_Feedback__Sequence * array = (create3_examples_msgs__action__Coverage_Feedback__Sequence *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  create3_examples_msgs__action__Coverage_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    create3_examples_msgs__action__Coverage_Feedback * data =
      (create3_examples_msgs__action__Coverage_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!create3_examples_msgs__action__Coverage_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          create3_examples_msgs__action__Coverage_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_SendGoal_Request * msg = (create3_examples_msgs__action__Coverage_SendGoal_Request *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
create3_examples_msgs__action__Coverage_SendGoal_Request__Sequence__init(create3_examples_msgs__action__Coverage_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (create3_examples_msgs__action__Coverage_SendGoal_Request *)allocator.zero_allocate(size, sizeof(create3_examples_msgs__action__Coverage_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_SendGoal_Request__Sequence * array = (create3_examples_msgs__action__Coverage_SendGoal_Request__Sequence *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  create3_examples_msgs__action__Coverage_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    create3_examples_msgs__action__Coverage_SendGoal_Request * data =
      (create3_examples_msgs__action__Coverage_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!create3_examples_msgs__action__Coverage_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          create3_examples_msgs__action__Coverage_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_SendGoal_Response * msg = (create3_examples_msgs__action__Coverage_SendGoal_Response *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
create3_examples_msgs__action__Coverage_SendGoal_Response__Sequence__init(create3_examples_msgs__action__Coverage_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (create3_examples_msgs__action__Coverage_SendGoal_Response *)allocator.zero_allocate(size, sizeof(create3_examples_msgs__action__Coverage_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_SendGoal_Response__Sequence * array = (create3_examples_msgs__action__Coverage_SendGoal_Response__Sequence *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  create3_examples_msgs__action__Coverage_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    create3_examples_msgs__action__Coverage_SendGoal_Response * data =
      (create3_examples_msgs__action__Coverage_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!create3_examples_msgs__action__Coverage_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          create3_examples_msgs__action__Coverage_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_GetResult_Request * msg = (create3_examples_msgs__action__Coverage_GetResult_Request *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
create3_examples_msgs__action__Coverage_GetResult_Request__Sequence__init(create3_examples_msgs__action__Coverage_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (create3_examples_msgs__action__Coverage_GetResult_Request *)allocator.zero_allocate(size, sizeof(create3_examples_msgs__action__Coverage_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_GetResult_Request__Sequence * array = (create3_examples_msgs__action__Coverage_GetResult_Request__Sequence *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  create3_examples_msgs__action__Coverage_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    create3_examples_msgs__action__Coverage_GetResult_Request * data =
      (create3_examples_msgs__action__Coverage_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!create3_examples_msgs__action__Coverage_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          create3_examples_msgs__action__Coverage_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_GetResult_Response * msg = (create3_examples_msgs__action__Coverage_GetResult_Response *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
create3_examples_msgs__action__Coverage_GetResult_Response__Sequence__init(create3_examples_msgs__action__Coverage_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (create3_examples_msgs__action__Coverage_GetResult_Response *)allocator.zero_allocate(size, sizeof(create3_examples_msgs__action__Coverage_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_GetResult_Response__Sequence * array = (create3_examples_msgs__action__Coverage_GetResult_Response__Sequence *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  create3_examples_msgs__action__Coverage_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    create3_examples_msgs__action__Coverage_GetResult_Response * data =
      (create3_examples_msgs__action__Coverage_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!create3_examples_msgs__action__Coverage_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          create3_examples_msgs__action__Coverage_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_FeedbackMessage * msg = (create3_examples_msgs__action__Coverage_FeedbackMessage *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
create3_examples_msgs__action__Coverage_FeedbackMessage__Sequence__init(create3_examples_msgs__action__Coverage_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (create3_examples_msgs__action__Coverage_FeedbackMessage *)allocator.zero_allocate(size, sizeof(create3_examples_msgs__action__Coverage_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  create3_examples_msgs__action__Coverage_FeedbackMessage__Sequence * array = (create3_examples_msgs__action__Coverage_FeedbackMessage__Sequence *)allocator.allocate(sizeof(create3_examples_msgs__action__Coverage_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  create3_examples_msgs__action__Coverage_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    create3_examples_msgs__action__Coverage_FeedbackMessage * data =
      (create3_examples_msgs__action__Coverage_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!create3_examples_msgs__action__Coverage_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          create3_examples_msgs__action__Coverage_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
